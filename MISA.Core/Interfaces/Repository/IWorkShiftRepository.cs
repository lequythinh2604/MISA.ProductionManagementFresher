...
namespace MISA.Core.Interfaces.Repository
{
    public interface IWorkShiftRepository
    {
        ...
        /// <summary>
        /// Kiểm tra mã ca đã tồn tại hay chưa
        /// </summary>
        /// <param name="workShiftCode"></param>
        /// <returns>true/false</returns>
        /// Created by: LQThinh (04/12/2025)
        bool IsWorkShiftExists(string workShiftCode);
        ...
        /// <summary>
        /// Kiểm tra trùng mã ca ngoại trừ excludeCode
        /// </summary>
        /// <param name="workShiftCode"></param>
        /// <param name="excludeCode"></param>
        /// <returns>true/false</returns>
        /// Created by: LQThinh (05/12/2025)
        bool IsWorkShiftCodeExists(string workShiftCode, string? excludeCode = null);
